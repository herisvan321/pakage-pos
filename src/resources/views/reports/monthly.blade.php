...
@section('header', 'Laporan Penjualan Bulanan')

@section('content')
<div class="mb-6">
    <form action="{{ route('pos.reports.monthly') }}" method="GET" class="flex items-center space-x-4">
        <div>
        ...
        <a href="{{ route('pos.reports.monthly') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
            Bulan Ini
        </a>
    </form>
</div>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    <div class="p-6 border-b">
        <h3 class="text-lg font-semibold text-gray-800">
            Penjualan Bulan {{ \Carbon\Carbon::parse($month . '-01')->format('F Y') }}
        </h3>
    </div>
    <table class="w-full">
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            @empty
            <tr>
                <td colspan="5" class="px-6 py-4 text-center text-gray-500">Tidak ada penjualan pada bulan ini</td>
            </tr>
            @endforelse
        </tbody>
    </table>
